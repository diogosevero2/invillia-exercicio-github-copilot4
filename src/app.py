...
activities = {
    ...
    "Basketball Club": {
        "description": "Practice drills and play friendly games against other schools",
    ...
    "Debate Team": {
        ...
        "max_participants": 16,
        "participants": ["henry@mergington.edu", "zelda@mergington.edu"]
    },
    "Math Club": {
        "description": "Work on problem solving, contests and enrichment activities",
